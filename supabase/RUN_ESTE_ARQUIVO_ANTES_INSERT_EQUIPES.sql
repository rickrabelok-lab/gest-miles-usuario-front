-- =============================================================================
-- PASSO 1 — Cole TUDO no Supabase → SQL Editor → Run (uma vez).
-- Só depois rode o insert em public.equipes (ex.: Gestão João Carvalho).
-- Se der erro em alguma linha, copie a mensagem inteira.
-- =============================================================================
...
-- =============================================================================
-- PASSO 2 — Nova query — criar equipe (troque o nome se quiser):
-- insert into public.equipes (nome) values ('Equipe 1 Rick e Silmaria') returning id;
--
-- Se a equipe já existe e só quer renomear (rode como admin / service role ou com policy):
-- update public.equipes
--   set nome = 'Equipe 1 Rick e Silmaria'
-- where nome = 'Equipe'   -- ou: where id = 'UUID-DA-SUA-EQUIPE';
-- =============================================================================

select 'OK: tabelas equipes / equipe_cs / equipe_gestores e funções aplicadas.' as resultado;
