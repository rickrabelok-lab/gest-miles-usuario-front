...
begin
  ...
  -- Mensagens canônicas para deduplicar entre trigger de alertas e triggers NPS/CSAT
...
-- 5.2) Notificar ao criar nova tarefa atribuída a um CS
...
-- 5.3) Notificar NPS_LOW diretamente (anti-duplicata via alertaKey canônico)
...
-- 5.4) Notificar CSAT_LOW diretamente (nota <= 2)
