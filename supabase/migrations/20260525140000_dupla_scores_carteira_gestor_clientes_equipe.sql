-- Inclui na CTE dupla_clientes: cliente_gestores + gestor_clientes + equipe_clientes (nac/intl),
-- igual à carteira unida em useGestor.supervisedClienteLinksQuery + equipeClientesGestorSnapshotQuery.
-- Apply se ainda vê 0 clientes após migrations anteriores (só cliente_gestores preenchida).
