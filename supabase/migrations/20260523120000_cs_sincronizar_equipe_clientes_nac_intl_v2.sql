-- Instalações que ja rodaram 20260522120000 com a versao `void` nao recebem
-- `create or replace` de assinatura diferente; dropar e recriar a funcao com returning.
-- Idempotente: o corpo e o mesmo ficheiro 20260522120000 (atual).

drop function if exists public.cs_sincronizar_equipe_clientes_nac_intl(uuid, uuid, uuid, uuid);
